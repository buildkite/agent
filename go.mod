...
require (
	...
	namespacelabs.dev/integrations v0.0.11-0.20260828132224-698446c0902e // Pinned for the parallel artifact downloader (not yet tagged).
)
...
tool (
	...
	github.com/buildkite/test-engine-client/v3
