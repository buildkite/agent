...
BUILDKITE_AGENT_JWKS_KEY_ID`
	...
	setEnv("BUILDKITE_CHECKOUT_PATH_INCLUDES_PIPELINE", fmt.Sprint(r.conf.AgentConfiguration.CheckoutPathIncludesPipeline))
	setEnv("BUILDKITE_CHECKOUT_PATH_INCLUDES_HOSTNAME", fmt.Sprint(r.conf.AgentConfiguration.CheckoutPathIncludesHostname))
	setEnv("BUILDKITE_CHECKOUT_PATH_INCLUDES_ORGANIZATION", fmt.Sprint(r.conf.AgentConfiguration.CheckoutPathIncludesOrganization))
