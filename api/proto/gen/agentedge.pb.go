...
func (x *StreamPingsResponse) GetEndpoint() string {
...
func (x *StreamPingsResponse) GetIdle() *IdleAction {
	if x != nil {
		if x, ok := x.Action.(*StreamPingsResponse_Idle); ok {
			return x.Idle
		}
	}
	return nil
...
type StreamPingsResponse_Idle struct {
	Idle *IdleAction `protobuf:"bytes,2,opt,name=idle,proto3,oneof"`
}
...
func (*StreamPingsResponse_Idle) isStreamPingsResponse_Action() {}
...
func (x *IdleAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IdleAction) ProtoMessage() {}

func (x *IdleAction) ProtoReflect() protoreflect.Message {
	mi := &file_agentedge_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IdleAction.ProtoReflect.Descriptor instead.
func (*IdleAction) Descriptor() ([]byte, []int) {
...
const file_agentedge_proto_rawDesc = "" +
	...
	"\bagent_id\x18\x01 \x01(\tR\aagentId\"\xb8\x02\n" +
	"\x13StreamPingsResponse\x12\x1f\n" +
	"\bendpoint\x18\x01 \x01(\tH\x01R\bendpoint\x88\x01\x01\x12.\n" +
	"\x04idle\x18\x02 \x01(\v2\x18.agentedge.v1.IdleActionH\x00R\x04idle\x121\n" +
...
var file_agentedge_proto_goTypes = []any{
	...
	(*IdleAction)(nil),          // 2: agentedge.v1.IdleAction
...
var file_agentedge_proto_depIdxs = []int32{
	2, // 0: agentedge.v1.StreamPingsResponse.idle:type_name -> agentedge.v1.IdleAction
