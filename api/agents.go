...
// AgentRegistrationTracing is non-secret tracing policy supplied by the
// control plane at registration. Exporter credentials remain job-scoped.
type AgentRegistrationTracing struct {
	Backend                    string `json:"backend"`
	PropagateTraceparent       bool   `json:"propagate_traceparent"`
	AcceptControlPlaneExporter bool   `json:"accept_control_plane_exporter"`
}
